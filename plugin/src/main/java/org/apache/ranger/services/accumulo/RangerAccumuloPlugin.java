...
public class RangerAccumuloPlugin extends RangerBasePlugin {

    private static final Log LOG = LogFactory.getLog(RangerAccumuloPlugin.class);
    ...
    Map<String, LogHistory> logHistoryList = new Hashtable<String, RangerAccumuloPlugin.LogHistory>();
    int logInterval = 30000; // 30 seconds

    public RangerAccumuloPlugin(String serviceType, String appId) {
